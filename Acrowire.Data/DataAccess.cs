...
namespace Acrowire.Data
{
    public partial class SqlDataAccess : IDisposable
    {
        ...
        #region [ Constructors ]
        public SqlDataAccess() : this("default")
        {
        }
        ...
        public static SqlDataAccess Create(string connection_string_name)
        {
            return new SqlDataAccess(ConfigurationManager.ConnectionStrings[connection_string_name].ConnectionString);
        }
        #endregion
